...
print (altmove,'altmove')
							...
							if (altmove > 0)then
								...
								if iswholenumber == false then
									...
									addNewOrder(WL.GameOrderAttackTransfer.Create(order.PlayerID,order.To,order.From,1,false,Game2.ServerGame.LatestTurnStanding.Territories[order.From].NumArmies,false))
