...
print (altmove,'altmove')
							...
							if (altmove > 0)then
								...
								if iswholenumber == false then
									...
									addNewOrder(WL.GameOrderAttackTransfer.Create(order.PlayerID,order.From,order.To,1,false,Game2.ServerGame.LatestTurnStanding.Territories[order.To].NumArmies,false))
