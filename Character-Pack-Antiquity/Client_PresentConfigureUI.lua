...
UnitTypeMax = InputFieldTable.UnitTypeMax.GetValue()
	...
	InputFieldTable[i].text3 = UI.CreateLabel(row2).SetText('How powerful Unit ' .. i .. ' is when attacking (in armies)').SetColor('#FFDDF4')
...
InputFieldTable[i].Minlife = UI.CreateNumberInputField(row10)
	...
	InputFieldTable[i].text13 = UI.CreateLabel(row11).SetText('Max Turns alive (Set to 0 to disable life range for Units)').SetColor('#FFDDF4')
InputFieldTable[i].Maxlife = UI.CreateNumberInputField(row11)
	...
	InputFieldTable[i].Image = UI.CreateNumberInputField(row4)
		...
		InputFieldTable[i].text6 = UI.CreateLabel(row6).SetText('Check if you want the Maximum amount to be shared between all players').SetColor('#FFDDF4')
		...
		InputFieldTable[i].text18 = UI.CreateLabel(row16).SetText('Check if you only want this unit moving every other turn').SetColor('#FFDDF4')
