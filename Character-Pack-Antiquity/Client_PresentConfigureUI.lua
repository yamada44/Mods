...
if (InputFieldTable[20].test.GetIsChecked() == false)then 
	for i = 1, UnitTypeMax do 
		...
		UI.destrpy(InputFieldTable[i].text1)
		UI.destrpy(InputFieldTable[i].text2)
		UI.destrpy(InputFieldTable[i].text3)
		UI.destrpy(InputFieldTable[i].text4)
		UI.destrpy(InputFieldTable[i].text5)
		UI.destrpy(InputFieldTable[i].text6)
		UI.destrpy(InputFieldTable[i].text7)
		UI.destrpy(InputFieldTable[i].text8)
		UI.destrpy(InputFieldTable[i].text9)
		UI.destrpy(InputFieldTable[i].text10)
		UI.destrpy(InputFieldTable[i].text11)
		UI.destrpy(InputFieldTable[i].costInputField)
		UI.destrpy(InputFieldTable[i].powerInputField)
		UI.destrpy(InputFieldTable[i].maxUnitsField)
		UI.destrpy(InputFieldTable[i].Image)
		UI.destrpy(InputFieldTable[i].Shared)
		UI.destrpy(InputFieldTable[i].Visible)
		UI.destrpy(InputFieldTable[i].MaxServer)
		UI.destrpy(InputFieldTable[i].Name)
