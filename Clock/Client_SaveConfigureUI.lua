...
--Second
    ...
    if sec > 200 or sec < 1 then alert("Mod set up failed\nCurrent Second value Must be between 1-200")
    else 
...
--Mintue
    ...
    if min > 200 or min < 1 then alert("Mod set up failed\nCurrent Mintue value Must be between 1-200")
    else 
...
--Hour
    ...
    if hour > 200 or min < 1 then alert("Mod set up failed\nCurrent Hour value Must be between 1-200")
    else 
