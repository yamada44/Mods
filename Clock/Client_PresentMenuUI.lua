...
--	local nameindex = Calculateweek(totaldays,short.NumberofWeekdays)
	...
	UI.CreateButton(row4).SetText("Help").SetColor('#1274A4').SetOnClick(function() UI.Alert('if your UI is messed up and your on the phone. turn your phone to the side') end)
