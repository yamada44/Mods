...
function Client_PresentSettingsUI(rootParent)
	...
	UI.CreateLabel(vert).SetText('Passing Seconds: ' .. time.ISecond).SetColor('#1274A5')
	UI.CreateLabel(vert).SetText('Passing Minutes: ' .. time.IMinute).SetColor('#1274A5')
	UI.CreateLabel(vert).SetText('Passing Hours: ' .. time.IHour).SetColor('#1274A5')
	UI.CreateLabel(vert).SetText('Passing Days: ' .. time.IDay).SetColor('#1274A5')
	UI.CreateLabel(vert).SetText('Passing Months: ' .. time.IMonth).SetColor('#1274A5')
	UI.CreateLabel(vert).SetText('Passing Years: ' .. time.IYear).SetColor('#1274A5')
	...
	UI.CreateLabel(vert).SetText('Before 0 : ' .. time.Before).SetColor('#1274A5')
	UI.CreateLabel(vert).SetText('After 0 : ' .. time.After).SetColor('#1274A5')
end
