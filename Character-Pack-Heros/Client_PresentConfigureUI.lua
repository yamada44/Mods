...
print (InputFieldTable[i].Template.GetIsChecked(),'template checker')
	...
	TempUI[i].unitcost = UI.CreateNumberInputField(row1)
		...
		TempUI[i].unitpower = UI.CreateNumberInputField(row2)
		.SetSliderMinValue(0)
		...
		TempUI[i].AttackMax = UI.CreateNumberInputField(row20)
		.SetSliderMinValue(0)
		.SetSliderMaxValue(30)
		.SetValue(attmax)
		...
		TempUI[i].Defend = UI.CreateNumberInputField(row15)
		.SetSliderMinValue(1)
		.SetSliderMaxValue(30)
		.SetValue(defend)
		...
		TempUI[i].Maxunits = UI.CreateNumberInputField(row3)
		.SetSliderMinValue(1)
		.SetSliderMaxValue(5)
		.SetValue(maxunits)
	...
	TempUI[i].Minlife = UI.CreateNumberInputField(row10)
	.SetSliderMinValue(0)
	...
	TempUI[i].Maxlife = UI.CreateNumberInputField(row11)
	.SetSliderMinValue(0)
	...
	-- image UI
		...
		TempUI[i].image = UI.CreateNumberInputField(row4)
		.SetSliderMinValue(0)
		...
		TempUI[i].Transfer = UI.CreateNumberInputField(row12)
		.SetSliderMinValue(0)
		...
		TempUI[i].Level = UI.CreateNumberInputField(row13)
		.SetSliderMinValue(0)
		...
		TempUI[i].Active = UI.CreateNumberInputField(row14)
		.SetSliderMinValue(0)
		...
		TempUI[i].MaxServer = UI.CreateNumberInputField(row9)
		.SetSliderMinValue(0)
		...
		TempUI[i].Cooldown = UI.CreateNumberInputField(row17)
		.SetSliderMinValue(0)
		.SetSliderMaxValue(100)
		.SetValue(cooldown)
		...
		TempUI[i].Assassination = UI.CreateNumberInputField(row19)
		.SetSliderMinValue(0)
		.SetSliderMaxValue(5)
		.SetValue(assass)
...
print(TempUI[i].Assassination,'name config',InputFieldTable[i].Assassination)
		...
		TempUI[i].Name = UI.CreateTextInputField(vert)
...
print(TempUI[i].Name,'name config',InputFieldTable[i].Name)
		...
		TempUI[i].HostRules = UI.CreateTextInputField(vert)
